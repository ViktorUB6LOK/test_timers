...
void power_off_ad9833 (){
	...
	AD9833_SetWaveData(0.0f, 0);  // пока так - далее переделать что откл модуль совсем!
}

void power_off_ad9833_2 (){
	// функция выключения модуля AD9833;
	AD9833_SetWaveData_2(0.0f, 0);  // пока так - далее переделать что откл модуль совсем!
}
